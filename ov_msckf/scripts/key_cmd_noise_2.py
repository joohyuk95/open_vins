...
class IMUNoiseParamControlNode_1:
    def __init__(self):
        rospy.init_node('imu_noise_param_control_node_1')
        ...
        self.imu_pub = rospy.Publisher('/imu2', Imu, queue_size=10)
...
if __name__ == '__main__':
    imu_noise_param_control_node_1 = IMUNoiseParamControlNode_1()
    imu_noise_param_control_node_1.handle_keyboard_input()
