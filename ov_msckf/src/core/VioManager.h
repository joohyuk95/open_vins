...
public:
   ...
   */
  VioManager(VioManagerOptions &params_, VioManagerOptions &params_1_);
   ...
   * @param message Contains our timestamp and inertial information
   */
  void feed_measurement_imu_1(const ov_core::ImuData &message);
  ...
  VioManagerOptions get_params_1() { return params_1; }

  /// Accessor to get the current state
  std::shared_ptr<State> get_state() { return state; }

  std::shared_ptr<State> get_combined_state() { return combined_state; }  
  void set_combined_state(std::shared_ptr<State> s) { combined_state = s; }  

  //aqeel
  std::shared_ptr<State> get_state_1() { return state_1; }
...
protected:
  ...
  std::shared_ptr<State> combined_state;
  ...
  // //aqeel
  std::shared_ptr<Propagator> propagator_1;
  ...
  // //aqeel
  std::shared_ptr<ov_init::InertialInitializer> initializer_1;

  /// Boolean if we are initialized or not
  bool is_initialized_vio = false;
  bool is_initialized_vio_1 = false;
  ...
  // //aqeel
  std::shared_ptr<UpdaterMSCKF> updaterMSCKF_1;


  /// Our SLAM/ARUCO feature updater
  std::shared_ptr<UpdaterSLAM> updaterSLAM;
  // //aqeel
  std::shared_ptr<UpdaterSLAM> updaterSLAM_1;

  /// Our zero velocity tracker
  std::shared_ptr<UpdaterZeroVelocity> updaterZUPT;

  // //aqeel
  std::shared_ptr<UpdaterZeroVelocity> updaterZUPT_1;
  ...
  bool did_zupt_update_1 = false;
  bool has_moved_since_zupt_1 = false;
