...
if __name__ == "__main__":
    ...
    def _main():
        ...
        annotation_path = '~/output_yolo_1/wh-train.txt'
        validation_path = '~/output_yolo_1/wh-val.txt'
        log_dir = '~/output_yolo_1/log/'
        classes_path = '~/output_yolo_1/wh_classes.txt'
        anchors_path = '~/output_yolo_1/wh_anchors.txt'
    ...
    def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
        ...
        print("Created model - ", [model_body.input, y_true], model_loss)
        # print(model.summary())
        return model
